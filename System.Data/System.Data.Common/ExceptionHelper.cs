    ...
    internal sealed class ExceptionHelper
    {
        ...
        internal static InvalidOperationException ConnectionNotOpened(string operationName, string connectionState)
        {
            ...
            return
                new InvalidOperationException(
                    GetExceptionMessage(
                        "{0} requires an open and available Connection. The connection's current state is {1}.", args));
        }
        ...
        internal static InvalidOperationException ConnectionStringNotInitialized()
        {
            return
                new InvalidOperationException(
                    GetExceptionMessage("The ConnectionString property has not been initialized."));
        }
                                                                              ...
                                                                              string parameterType, int parameterSize)
        {
            ...
            return
                new InvalidOperationException(
                    GetExceptionMessage(
                        "Parameter {0}: '{1}' of type: {2}, the property Size has an invalid size: {3}", args));
        }
        ...
        internal static DataException RowUpdatedError()
        {
            return
                new DataException(
                    GetExceptionMessage("RowUpdatedEvent: Errors occurred; no additional is information available."));
        }
